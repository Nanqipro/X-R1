...
# API配置
DEEPSEEK_API_KEY = "sk-60e54dd882314d11b6dd43fe1bf55f11"
...
class DatasetGenerator:
    ...
    def _save_intermediate_results(self, data: List[Dict], output_file: str) -> None:
        """
        保存中间结果
    ...
    def _save_final_results(self, data: List[Dict], output_file: str) -> bool:
        """
        保存最终结果
